...
const CloseSidebarDetail = () => {
  state.isSidebarVideo = false;
};
</script>

<template>
  <div
    class="fixed inset-0 bg-[rgba(23,23,23,0.5)] z-50"
    :class="{
      invisible: !state.isSidebarVideo,
    }"
  >
    <div
      class="w-[280px] bg-[#070707] fixed transition-all duration-300 ease-in left-0 top-0 bottom-0 overflow-y-scroll scroll-bar-hover"
      :class="{
        ' translate-x-[0px]': state.isSidebarVideo,
        'translate-x-[-280px]': !state.isSidebarVideo,
      }"
    >
      <div class="mt-[10px] px-[20px] pb-[50px]">
        <!-- side bar short -->

        <!-- logo -->
        <div class="flex items-center mb-[25px]">
          <div
            class="text-white cursor-pointer w-[45px] h-[45px] rounded-full relative flex items-center justify-center hover:bg-[#272727] ease-in duration-400 transition"
          >
            <div @click="CloseSidebarDetail">
              <svg
                height="24"
                viewBox="0 0 24 24"
                width="24"
        ...
        <div>
          <ul>
            <li
              class="max-h-[45px] h-[45px] flex items-center rounded-xl pl-[8px] cursor-pointer hover:bg-[#272727] ease-in duration-400 transition"
            >
              <div>
                <svg
              ...
              <router-link to="/">
                <span
                  class="text-[#f1f1f1] font-medium font-roboto text-[15px] block ml-[27px] translate-y-[1px]"
                  >Trang chủ</span
                >
              </router-link>
            </li>
        ...
        <!-- side bar lib -->
        <div>
          <ul class="mt-[15px] pt-[15px] block border-t border-[#646464]">
            <li
              class="max-h-[45px] h-[45px] flex items-center rounded-xl pl-[8px] cursor-pointer hover:bg-[#272727] ease-in duration-400 transition"
            >
              <div>
            ...
            <li
              class="max-h-[45px] h-[45px] flex items-center rounded-xl pl-[8px] cursor-pointer hover:bg-[#272727] ease-in duration-400 transition"
            >
              <div class="max-w-[24px] max-h-[24px] rounded-full">
                <svg
                  height="24"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <!-- side bar register -->
        <div>
          <ul class="mt-[15px] pt-[10px] block border-t border-[#646464]">
            <li class="max-h-[45px] h-[45px]">
              <h4 class="text-white font-medium">Kênh đăng ký</h4>
            </li>
            <li
              class="max-h-[45px] h-[45px] flex items-center rounded-xl pl-[8px] cursor-pointer hover:bg-[#272727] ease-in duration-400 transition"
            >
              <div class="max-w-[24px] max-h-[24px] rounded-full">
                <img
                  src="https://yt3.ggpht.com/NrIEzYVk5mBH9yRIefVDnvyD7YQpvbmOUx-LRNaC7KCc1DQ82B-bvURmZbEhZoCllobJjCBq=s88-c-k-c0x00ffffff-no-rj"
                  alt="avatar user"
        ...
        <div>
          <ul class="mt-[15px] pt-[10px] block border-t border-[#646464]">
            <li class="max-h-[45px] h-[45px]">
              <h4 class="text-white font-medium">Khám phá</h4>
            </li>
            <li
              class="max-h-[45px] h-[45px] flex items-center rounded-xl pl-[8px] cursor-pointer hover:bg-[#272727] ease-in duration-400 transition"
            >
        ...
        <!-- side bar other service -->
        <div>
          <ul class="mt-[15px] pt-[10px] block border-t border-[#646464]">
            <li class="max-h-[45px] h-[45px]">
              <h4 class="text-white font-medium">Dịch vụ khác của Youtube</h4>
            </li>
            <li
              class="max-h-[45px] h-[45px] flex items-center rounded-xl pl-[8px] cursor-pointer hover:bg-[#272727] ease-in duration-400 transition"
            >
        ...
        <div>
          <ul class="mt-[15px] pt-[15px] block border-t border-[#646464]">
            <li
              class="max-h-[45px] h-[45px] flex items-center rounded-xl pl-[8px] cursor-pointer bg-[#272727] hover:bg-[#272727] ease-in duration-400 transition"
            >
              <div>
                <svg
                  enable-background="new 0 0 24 24"
        ...
        <div>
          <ul
            class="mt-[15px] pt-[15px] pl-[15px] block border-t border-[#646464]"
          >
            <router-link to="/" class="mr-[5px]"
              ><span class="text-[#AAAAAA] text-[13px] font-semibold"
                >Giới thiệu</span
              ></router-link
            >
            <router-link to="/" class="mr-[5px]"
...
.scroll-bar-hover:hover::-webkit-scrollbar-thumb {
  background: #646464;
}
::-webkit-scrollbar {
  width: 0px;
